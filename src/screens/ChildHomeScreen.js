...
const ChildHomeScreen = ({ navigation }) => {
  ...
  const renderTask = (task, actionLabel, action) => (
    ...
    >
      ...
      <Text style={{ color: '#6e6969' }}>Atlygis: {task.rewardETH} ETH ({task.rewardEUR} EUR)</Text>
      <Text style={{ color: '#6e6969' }}>Terminas: {new Date(task.deadline).toLocaleString()}</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ color: '#6e6969' }}>Balansas: {balance.ETH} ETH ({balance.EUR} EUR)</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={{ color: '#6e6969' }}>Šiuo metu nėra aktyvių užduočių.</Text>}
      />
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={{ color: '#6e6969' }}>Šiuo metu nėra laukiamų peržiūros užduočių.</Text>}
      />
      ...
      <FlatList
        ...
        keyExtractor={item => item.id}
        renderItem={({ item }) => renderTask(item)} // Tik rodymas su navigacija
        ListEmptyComponent={<Text style={{ color: '#6e6969' }}>Šiuo metu nėra atliktų užduočių.</Text>}
      />
      ...
      <FlatList
        ...
        keyExtractor={item => item.id}
        renderItem={({ item }) => renderTask(item)} // Tik rodymas su navigacija
        ListEmptyComponent={<Text style={{ color: '#6e6969' }}>Šiuo metu nėra neįvykdytų užduočių.</Text>}
      />
